...
public class JobScheduleBuilder {
    ...
    public JobDetail createJob(String jobName, String jobGroup, Class<? extends QuartzJobBean> jobClass, boolean isDurable,
                               ApplicationContext context, Map<String, Object> jobParameters) {
